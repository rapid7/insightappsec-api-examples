...
from lib.helpers import application_onboarding
...
def main():
    ...
    # Setup basic logging
    logging.basicConfig(filename="../log/application_onboarding.log", filemode="a", level=logging.INFO,
    ...
    application_onboarding.create_application(api_key, region, settings)
